        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild className="hover:bg-white/10 rounded-2xl transition-all duration-300">
              <a href="/dashboard">
                <div className="flex aspect-square size-12 items-center justify-center rounded-2xl gradient-primary neon-glow">
                  <Sparkles className="size-6 text-white" />
                </div>
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-bold text-xl gradient-text">SEO Genesis</span>
